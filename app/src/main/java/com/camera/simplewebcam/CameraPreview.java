...
//        		rect = new Rect(0, 0, winWidth-1, winWidth*3/4-1);
        		if(winWidth*3/4<=winHeight){
        			dw = 0;
        			dh = (winHeight-winWidth*3/4);
        			rate = ((float)winWidth)/IMG_WIDTH;
        			rect = new Rect(0,0,dw+winWidth-1,dh+winWidth*3/4-1);
        		}else{
        			dw = (winWidth-winHeight*4/3);
        			dh = 0;
        			rate = ((float)winHeight)/IMG_HEIGHT;
        			rect = new Rect(0,0,dw+winHeight*4/3 -1,dh+winHeight-1);
        		}
        	}
